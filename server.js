...
const url="mongodb://Nani:Nani@cluster0-shard-00-00-aoc6o.mongodb.net:27017,cluster0-shard-00-01-aoc6o.mongodb.net:27017,cluster0-shard-00-02-aoc6o.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority";
var dbo;
                    ...
                    {$set:{count:ct}},(error,suc)=>{
                        if(error){
                            ...
                            const transport = nodemailer.createTransport({
                                ...
                                auth: {
                                    user: 'jestaranjith@gmail.com',
                                    pass: 'Ammulu83745',
                                }

                            });
                            const mailOptions = {
                                from: '"nani" <jestaranjith@gmail.com>',
